...
if (isset($_POST["submit"])) {
    ...
    if ($errmsg == "") {
        ...
        try {
            ...
            $sql = $db->prepare("insert into customerlist (firstname,lastname,address,city,state,zipcode,phone,password,email,custID) VALUE(:fname, :lname, :address, :city, :state, :zipcode, :phone, :password, :email, :key)");
        ...
        <section class="main-content" role="main">
            ...
            <div class="form" style="width:500px;">
                <form method="post">
                    ...
                    <a class="button" href="customerlist.php">Cancel</a>
                </form>
            </div>
        </section>
