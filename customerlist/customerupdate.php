                            ...
                            if (isset($_POST["txtEmail"])) {
                                if (isset($_POST["txtPassword"])) {
                                    ...
                                    try {
                                        ...
                                        $sql = $db->prepare("update customerlist set firstname=:firstname, lastname=:lastname, address=:address, city=:city, state=:state, zipcode=:zipcode, phone=:phone, password=:password, email=:email, custID=:key where custID=:id");
                                        $sql->bindValue(":id", $id);
